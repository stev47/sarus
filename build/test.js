...
},{"./loki-indexed-adapter.js":2,"fs":1}],4:[function(require,module,exports){
...
},{"handler":"handler"}],"handler":[function(require,module,exports){
var loki = require('lokijs')

let db = new Promise((res, rej) => {
    let db = new loki('data/sarus.db', {
        autoload: true,
        autosave: true,
        autoloadCallback: () => res(db),
    })
...
db.then(db => {
    ...
    var colTest = db.getCollection('test') || db.addCollection('test')
